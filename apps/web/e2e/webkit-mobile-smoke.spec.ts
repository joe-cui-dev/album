...
/**
 * 320px WebKit functional smoke (implementation doc "Verification"). Runs only under the
 * `mobile-webkit` Playwright project (see `playwright.config.ts`): WebKit engine, 320px viewport.
 */
test("320px WebKit: browses Timeline, jumps via the mobile sheet, and opens the Viewer", async ({ mock, page }) => {
